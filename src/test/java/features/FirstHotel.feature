Feature: FirstHotelFeature

  Scenario: Verify that 'Reserve' button is Enabled on First Hotel Page
    ...
    Then I verify that 'Reserve' button is Enabled on First Hotel Page